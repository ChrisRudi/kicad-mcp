...
SHIPPED_TOOL = {
    ...
    "pin_swap": "connect_pins",
    "nl_navigation": "analyze_pcb_nets",
    "select_place": "ipc_move_items",
    "watch_mode": "live_summarize_user_changes",
    "xtal_caps": "audit_design",
    "thermal": "audit_power_tree",
    "operating_temp": "list_pcb_footprints",
    "slew_rate": "list_schematic_components",
    "impedance": "pcb_eval",
    ...
    "safety_spacing": "center_item_clearance",
    "firmware_map": "extract_schematic_netlist",
