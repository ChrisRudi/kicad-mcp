...
def register_bom_resources(mcp: FastMCP) -> None:
            ...
            try:
                ...
                if bom_data:
                    ...
                    if columns:
                        ...
                        for _i, component in enumerate(bom_data[:20]):
                            row = []
                            for col in columns:
                ...
                logger.error(f"Error processing BOM file {file_path}: {str(e)}")
    ...
    def get_bom_csv_resource(project_path: str) -> str:
        ...
        try:
            ...
            bom_data, _format_info = parse_bom_file(file_path)
            ...
            logger.error(f"Error generating CSV from BOM file: {str(e)}")
    ...
    def get_bom_json_resource(project_path: str) -> str:
        ...
        try:
            ...
            logger.error(f"Error generating JSON from BOM file: {str(e)}")
