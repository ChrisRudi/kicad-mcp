...
Non-ASCII paths (e.g. a Windows username ``üser``) must NEVER appear as
...
def _write_temp_bat(text: str) -> str:
    ...
    # would replace non-ASCII path chars (e.g. ü in C:\Users\üser) with "?",
...
def open_terminal(commands, title="", cwd=None, env=None,
    ...
    if os.name == "nt":
        ...
        # expand uncorrupted even for usernames like "üser".
