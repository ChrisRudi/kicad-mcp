...
FEATURES: tuple[SuperFeature, ...] = (
    ...
    SuperFeature(
        ...
        prompt=("Datenblatt-Abgleich: Steht oben im Kontext eine Auswahl mit "
                ...
                "und welche fehlen, und frage, welches IC ich reviewen will. "
                "Fehlt das PDF des gewählten ICs, SUCHE es selbst per "
                "WebSearch: finde das offizielle Hersteller-Datenblatt (PDF), "
                "nenne Quelle und direkte URL und wohin es gehört "
                "(docs/<Value>.pdf), und mache den Abgleich gegen das online "
                "gefundene Datenblatt weiter — statt nur nach dem PDF zu "
                "fragen. EHRLICH: Web-Momentaufnahme, vor kritischen "
                "Entscheidungen selbst verifizieren. Keine Board-Änderung, "
                "kein pcb_render."),
        category="verstehen",
    ),
    SuperFeature(
    ...
    SuperFeature(
        ...
        prompt=(
                ...
                "das CL des Quarzes aus dem Datenblatt (docs/<Value>.pdf); "
                "fehlt es, SUCHE das Quarz-Datenblatt per WebSearch und nenne "
                "CL samt Quelle/URL, statt zu fragen; rechne C = 2·(CL − "
                "Cstray) mit Cstray "
    ...
    SuperFeature(
        ...
        prompt=(
                ...
                "docs/; fehlt es, per WebSearch das Bauteil-Datenblatt suchen "
                "und die Slew-Rate samt Quelle/URL nennen, statt zu fragen; "
    ...
    SuperFeature(
        ...
        prompt=(
                ...
                "und frage, welches IC gemeint ist. Keiner → SUCHE das "
                "Datenblatt selbst per WebSearch (offizielles Hersteller-PDF), "
                "nenne Quelle und direkte URL und wohin es gehört "
                "(docs/<Value>.pdf); kannst du es lokal ablegen, nutze "
                "darauf extract_circuit_from_pdf, sonst skizziere die typische "
                "Applikationsschaltung aus dem online gefundenen Datenblatt — "
                "statt zu stoppen. (2) "
